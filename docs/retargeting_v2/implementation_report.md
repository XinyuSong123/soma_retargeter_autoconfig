...
- Morphology-scheduled direction-objective analytic Jacobians: `soma_retargeter/pipelines/ik_objectives.py`, `soma_retargeter/pipelines/newton_pipeline.py`, and `soma_retargeter/robot_registry_parser.py`
