...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--source", choices=("git", "workspace"), default="git")
    ...
    source_commit = args.baseline_commit if args.source == "git" else None
