...
UNITREE_G1_POSE_PAIR_ROOT = CONFIG_ROOT / "unitree_g1" / "pose_pairs"
E3_V2_POSE_PAIR_ROOT = CONFIG_ROOT / "e3_v2" / "pose_pairs"

# xml路径
ROBOT_XML_DICT = {
    "roboparty_rpo": ROBOT_ROOT / "atom01" / "mjcf" / "atom01.xml",
    "unitree_g1": ROBOT_ROOT / "unitree_g1" / "mjcf" / "g1_29dof_rev_1_0.xml",
    "e3_v2": ROBOT_ROOT / "e3_v2" / "e3.xml",
...
ROBOT_URDF_DICT = {
    ...
    "unitree_g1": ROBOT_ROOT / "unitree_g1" / "urdf" / "g1_29dof_rev_1_0.urdf",
}
...
POSE_PAIR_JSON_DICT = {
    "unitree_g1": {
        ...
        "t_pose": UNITREE_G1_POSE_PAIR_ROOT / "unitree_g1_t_pose.json",
        "natural_down": UNITREE_G1_POSE_PAIR_ROOT / "unitree_g1_natural_down.json",
        "both_elbows_forward_90": UNITREE_G1_POSE_PAIR_ROOT / "unitree_g1_both_elbows_forward_90.json",

    },

    "e3_v2": {
        "t_pose": E3_V2_POSE_PAIR_ROOT / "e3_v2_t_pose.json",
        "natural_down": E3_V2_POSE_PAIR_ROOT / "e3_v2_natural_down.json",
        "both_elbows_forward_90": E3_V2_POSE_PAIR_ROOT / "e3_v2_both_elbows_forward_90.json",
        # "arms_forward_squat_hip_yaw_out_45": E3_V2_POSE_PAIR_ROOT / "e3_v2_arms_forward_squat_hip_yaw_out_45.json",
    },
