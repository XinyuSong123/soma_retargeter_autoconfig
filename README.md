...
Compiled profiles record root-motion scale and ground-height provenance from semantic hips/feet when available, with explicit fallback warnings when morphology is insufficient.
